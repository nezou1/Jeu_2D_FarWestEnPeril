...
public class Bombe extends Projectile {
    ...
    public Bombe(int x, int y, Direction direction, Environnement2 env) {
...
//        }
        seDeplace();
        ArrayList<Ennemi2> ennemis = chercheEnnemis();
     ...
     * </ol>
     */
    private ArrayList<Ennemi2> chercheEnnemis(){
        ArrayList<Ennemi2> ennemisProches = new ArrayList<>();
