 ...
 *          <li>un {@link Environnement2 environnement</li>
 *      </ul>
...
public abstract class ActeurMobile extends Acteur {
    ...
    public ActeurMobile(String id, int x, int y, Direction direction, int vitesse, Environnement2 env) {
        super(id, env);
     ...
     *     <li>Elle vérifie si l'emplacement est possible {@link Environnement2#estMarchable(int, int)}</li>
