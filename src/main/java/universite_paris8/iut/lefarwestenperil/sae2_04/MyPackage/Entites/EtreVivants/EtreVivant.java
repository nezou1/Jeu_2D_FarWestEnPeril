...
import universite_paris8.iut.lefarwestenperil.sae2_04.MyPackage.Etats.Etat;
...
public abstract class EtreVivant extends ActeurMobile {
    ...
    public EtreVivant(String id, int x, int y, Direction direction, int vitesse, Environnement2 env, int pv, int def) {
